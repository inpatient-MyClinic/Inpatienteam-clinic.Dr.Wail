...
-- Unified view (LIVE + EXCEL) - properly handle enum status
...
('global','numerator_statuses','["completed","scheduled","in-progress"]')
on conflict (scope,key) do nothing;

insert into sia_settings(scope,key,value) values
('global','loss_cancelled_statuses','["cancelled","rejected"]')
on conflict (scope,key) do nothing;

insert into sia_settings(scope,key,value) values
('global','loss_pending_statuses','["pending"]')
on conflict (scope,key) do nothing;
